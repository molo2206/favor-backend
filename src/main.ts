...
// 🔹 Charger les variables d'environnement dès le lancement
dotenv.config();

async function bootstrap() {
  const app = await NestFactory.create<NestExpressApplication>(AppModule);

  // 🔹 MODIFICATION MINIMALE MAIS CRUCIALE : Écouter sur toutes les interfaces
  ...
  // 🔹 Démarrer avec la configuration modifiée
  await app.listen(PORT, HOST);

  // 🔹 Affichage amélioré pour confirmer le fonctionnement DHCP
