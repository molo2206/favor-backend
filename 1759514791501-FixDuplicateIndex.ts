...
export class FixDuplicateIndex1759514791501 implements MigrationInterface {
    name = 'FixDuplicateIndex1759514791501'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`device_tokens\` (\`id\` varchar(36) NOT NULL, \`userId\` varchar(255) NOT NULL, \`token\` varchar(255) NOT NULL, \`platform\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_977e24c520c49436d08e5eeea8\` (\`token\`), UNIQUE INDEX \`IDX_977e24c520c49436d08e5eeea8\` (\`token\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user_notifications\` (\`id\` varchar(36) NOT NULL, \`userId\` varchar(255) NOT NULL, \`title\` varchar(255) NOT NULL, \`body\` varchar(255) NOT NULL, \`type\` varchar(255) NOT NULL, \`data\` json NOT NULL, \`hasSeen\` tinyint NOT NULL DEFAULT 0, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`fcmToken\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`platform\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`provider\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`fonction\` \`fonction\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`description\` \`description\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`price\` \`price\` decimal(10,2) NULL`);
        await queryRunner.query(`ALTER TABLE \`service\` DROP COLUMN \`imageUrls\``);
        await queryRunner.query(`ALTER TABLE \`service\` ADD \`imageUrls\` json NULL`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`companyId\` \`companyId\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`categoryId\` \`categoryId\` varchar(36) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`room\` CHANGE \`measureId\` \`measureId\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`room\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`room\` ADD CONSTRAINT \`FK_a81b8055e21ed129a8c3b153042\` FOREIGN KEY (\`measureId\`) REFERENCES \`measures\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`booking\` CHANGE \`userId\` \`userId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`booking\` ADD CONSTRAINT \`FK_336b3f4a235460dc93645fbf222\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`room_image\` CHANGE \`roomId\` \`roomId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`room_image\` CHANGE \`altText\` \`altText\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`room_image\` ADD CONSTRAINT \`FK_8652478a73dd49bbfcf14775e3e\` FOREIGN KEY (\`roomId\`) REFERENCES \`room\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`products\` ADD CONSTRAINT \`FK_f3cd3ac28f81bbb08bd7d119e04\` FOREIGN KEY (\`measureId\`) REFERENCES \`measures\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD CONSTRAINT \`FK_9a5f6868c96e0069e699f33e124\` FOREIGN KEY (\`category_id\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`sale_transaction\` CHANGE \`saleNumber\` \`saleNumber\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`sale_transaction\` CHANGE \`paymentStatus\` \`paymentStatus\` enum ('PENDING', 'PAID', 'VALIDATED', 'PROCESSING', 'COMPLETED', 'DELIVERED', 'REJECTED') NOT NULL DEFAULT ''PENDING''`);
        await queryRunner.query(`ALTER TABLE \`rental_contracts\` CHANGE \`rentalNumber\` \`rentalNumber\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`category\` ADD CONSTRAINT \`FK_1117b4fcb3cd4abb4383e1c2743\` FOREIGN KEY (\`parent_id\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`categoryId\` \`categoryId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`companyId\` \`companyId\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`service\` DROP COLUMN \`imageUrls\``);
        await queryRunner.query(`ALTER TABLE \`service\` ADD \`imageUrls\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`price\` \`price\` decimal(10,2) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`service\` CHANGE \`fonction\` \`fonction\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`service\` ADD CONSTRAINT \`FK_cb169715cbb8c74f263ba192ca8\` FOREIGN KEY (\`categoryId\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`service\` ADD CONSTRAINT \`FK_02fbdab4c697f74792472b88546\` FOREIGN KEY (\`companyId\`) REFERENCES \`company\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_977e24c520c49436d08e5eeea8\` ON \`device_tokens\``);
        await queryRunner.query(`DROP INDEX \`IDX_977e24c520c49436d08e5eeea8\` ON \`device_tokens\``);
